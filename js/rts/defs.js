...
(() => {
  ...
  const U = {
    ...
    rifle: {
      ...
      pop: 1,
      time: 8,
      cost: { steel: 40, fuel: 10 },
      from: "barracks",
      role: "Line infantry. Cheap, holds ground, dies to anything with a cannon.",
    },
    mg: {
      ...
      pop: 2,
      time: 13,
      cost: { steel: 78, fuel: 16 },
      from: "barracks",
      role: "Shreds infantry. Cannot scratch armour — keep it behind the tanks.",
    },
    at: {
      name: "Anti-Tank Team",
      short: "AT",
      ...
      pop: 2,
      time: 15,
      cost: { steel: 95, fuel: 22 },
      from: "barracks",
      role: "Rockets. The cheap answer to armour, if it gets to shoot first.",
    },
    sniper: {
      name: "Marksman",
      short: "SNP",
      ...
      pop: 2,
      time: 19,
      cost: { steel: 118, fuel: 26 },
      from: "barracks",
      stealth: true,
      role: "Outranges everything on the ground. Wrecks crews, ignores tanks.",
    },
    eng: {
      name: "Engineers",
      short: "ENG",
      ...
      pop: 1,
      time: 11,
      cost: { steel: 48, fuel: 8 },
      from: "barracks",
      repair: 26,
      build: 1,
      role: "Mends vehicles and raises defences. Fight with them and you lose them.",
    },
    ...
    zwalker: {
      ...
      cost: {},
      horde: true,
      role: "One of them is nothing. A thousand of them is a wall.",
    },
    zrunner: {
      name: "Runner",
      short: "RUN",
      ...
      cost: {},
      horde: true,
      role: "It closes the distance before you finish turning.",
    },
    zspitter: {
      name: "Spitter",
      short: "SPT",
      ...
      cost: {},
      horde: true,
      role: "Acid, at range. Kill it first.",
    },
    zbrute: {
      name: "Brute",
      short: "BRT",
      ...
      cost: {},
      horde: true,
      role: "It walks through a wall rather than around it.",
    },
    zhulk: {
      name: "Hulk",
      short: "HLK",
      ...
      cost: {},
      horde: true,
      role: "A tank's worth of rot. Bring a tank.",
    },
  };
  ...
  R.PRODUCES = {
    barracks: ["rifle", "mg", "at", "sniper", "eng"],
  ...
  R.BUILD_MENU = [
    ...
    },
    {
      key: "mil",
      name: "Military",
      keys: ["barracks", "works", "airfield", "shipyard", "repair", "radar"],
    },
    {
      key: "def",
      name: "Defence",
